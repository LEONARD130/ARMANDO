...
ob_start();
error_reporting(0);
define('API_KEY','1038714845:AAFS3NfFi2PAjRnKVGf4RnhN9TqDv5L202Q');
$Dev = array("765588483","765588483","765588483");
...
'chat_id'=>$chat_id,
'text'=>"
👨‍🎓¦ أهلا عزيزي [المنشىء](tg://user?id=$from_id) 👷🏽
📡¦ تم قفل الاعضاء
✓
...
'chat_id'=>$chat_id,
'text'=>"
👨‍🎓¦ أهلا عزيزي [المشرف](tg://user?id=$from_id) 👷🏽
📡¦ تم قفل الاعضاء
✓
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,'reply_to_message_id'=>$message_id,
]);
...
'chat_id'=>$chat_id,
'text'=>"
👨‍🎓¦ أهلا عزيزي [المطور](tg://user?id=$from_id) 👷🏽
📡¦ تم قفل الاعضاء
✓
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
'parse_mode'=>"markdown"
...
'chat_id'=>$chat_id,
'text'=>"
👨‍🎓¦ أهلا عزيزي [المدير](tg://user?id=$from_id) 👷🏽
📡¦ تم قفل الاعضاء
✓
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
'parse_mode'=>"markdown"
...
'chat_id'=>$chat_id,
'text'=>"
👨‍🎓¦ أهلا عزيزي [الادمن](tg://user?id=$from_id) 👷🏽
📡¦ تم قفل الاعضاء
✓
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
'parse_mode'=>"markdown"
...
'chat_id'=>$chat_id,
'text'=>"
👨‍🎓¦ أهلا عزيزي [المنشئ](tg://user?id=$from_id) 👷🏽
📡¦ تم فتح الاعضاء
✓
...
'chat_id'=>$chat_id,
'text'=>"
👨‍🎓¦ أهلا عزيزي [$first_name](tg://user?id=$from_id) 👷🏽
📡¦ تم وضع العدد *$code*
✓
",
'reply_to_message_id'=>$message_id,'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
